...
---
<details><summary><h3>vanilla GAN</h3></summary>  
<br>
...
- $$\mathcal{L}_{idt}: \mathbb{E}_{y\~p_{data}(y)}[\lVert G(y)-y \rVert_{1}] + \mathbb{E}_{x\~p_{data}(x)}[\lVert F(x)-x \rVert_{1}]$$ <br><br>
