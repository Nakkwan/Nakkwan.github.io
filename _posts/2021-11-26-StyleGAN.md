...
<ul>
<li>PPL (Perceptual Path Length)</li>
...
<li>Instance normalization revisited</li>
    ...
    \end{align}
    \mathcal{w}^\prime\prime_{ijk}가 최종 Convolution weight가 된다. 하지만 feature map을 직접 쓰는 것이 아닌 신호에 대한 가정이 추가되기 때문에 normalization보단 약하다.
</ul> <br>
